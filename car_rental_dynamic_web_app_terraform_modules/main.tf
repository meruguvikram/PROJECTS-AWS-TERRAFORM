...
module "ecs" {
  source                       = "git@github.com:Silas-cloudspace/terraform-modules.git//ecs"
  project_name                 = local.project_name
  environment                  = local.environment
...
module "asg_ecs" {
  source = "git@github.com:Silas-cloudspace/terraform-modules.git//asg_ecs"
  project_name = local.project_name
  environment = local.environment
...
module "route53" {
  source = "git@github.com:Silas-cloudspace/terraform-modules.git//route53"
